        ...
        @if (auth()->user()->role_id == 1)
            <div class="my-3">
                ...
                <input type="text" name="name" id="name" wire:model.blur="late" placeholder="0"
                    class="md:w-1/12 w-1/6 px-3 py-2 border rounded-md dark:border-[#FFFFFF1A] border-[#1C1C1C1A] dark:bg-[#1C1C1CCC] dark:text-white text-black">
            ...
            <div class="my-3">
                ...
                <input type="time" name="name" id="name" wire:model.blur="time" placeholder="0"
                    class="md:w-1/6 w-2/5 px-3 py-2 border rounded-md dark:[color-scheme:dark] dark:border-[#FFFFFF1A] border-[#1C1C1C1A] dark:bg-[#1C1C1CCC] dark:text-white text-black">
            </div>
        @endif
        <div class="my-3">
