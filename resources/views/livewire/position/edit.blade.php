...
<x-page-layout>
    <x-slot:breadcrumbs>
        ...
        <li class="flex items-center space-x-1">
            <span class="px-1 py-2 text-[#1C1C1C66] dark:text-[#FFFFFF66] text-sm">/</span>
            <span class="px-1 py-2 text-black dark:text-white text-sm">Lihat/Ubah Jabatan</span>
        </li>
    </x-slot:breadcrumbs>

    <form wire:submit="save">
        <div class="flex justify-between items-center">
            <p class="py-1 px-2 text-sm font-semibold text-black dark:text-white">Lihat/Ubah Jabatan</p>
            <button type="submit" wire:dirty.attr.remove="disabled" disabled
                class="py-1 px-2 bg-black dark:bg-[#C6C7F8] text-xs text-white dark:text-black rounded-lg disabled:opacity-50 disabled:cursor-not-allowed">Simpan</button>
        </div>
        <div class="mt-5 w-full grid grid-cols-1 p-6 rounded-2xl dark:bg-[#FFFFFF0D] bg-[#F7F9FB] gap-6">
            <div class="">
                ...
                <input type="text" name="name" id="name" wire:model="name" placeholder="Gelar Depan"
