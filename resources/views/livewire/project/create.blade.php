    ...
    <form wire:submit="save">
        ...
        <div class="mt-5 w-full grid md:grid-cols-4 grid-cols-1 p-6 rounded-2xl dark:bg-[#FFFFFF0D] bg-[#F7F9FB] gap-6">
            ...
            <div class="md:col-span-3 grid md:grid-cols-2 grid-cols-1 gap-4" x-data="leaflet">
                ...
                <div class="">
                    <label for="start_tolerance_overtime" class="text-sm block dark:text-white text-black mb-2">
                        Jam Mulai Toleransi Telat Setelah Lembur
                    </label>
                ...
                <div class="">
                    <label for="duration_tolerance_overtime" class="text-sm block dark:text-white text-black mb-2">
                        Durasi Perhitungan Setelah Jam Keluar
                    </label>
