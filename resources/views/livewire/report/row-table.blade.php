<tr
    class="text-black dark:text-white print:dark:text-black text-xs print:odd:bg-white print:even:bg-slate-50 print:odd:dark:bg-white print:even:dark:bg-slate-50">
    <td class="py-3 font-normal ">{{ $user->profile->name }}</td>
    ...
    @if (auth()->user()->role_id != 1)
        <td class="py-3 font-normal min-w-16 max-w-16 text-nowrap">
        ...
        <td class="py-3 font-normal min-w-20">
            <p class="">Rp{{ $total_uang_makan }}</p>
        </td>
        <td class="py-3 font-normal"></td>
    @endif
</tr>
