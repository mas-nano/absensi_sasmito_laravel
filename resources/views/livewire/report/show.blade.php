    ...
    <div x-data="{ show: @entangle('show') }">
        <div class="flex justify-between items-center">
            ...
            <button class="py-1 px-2 bg-black dark:bg-[#a4a5f7] text-xs text-white dark:text-black rounded-lg"
                    {{-- wire:click="$dispatch('openModal', { component: 'report.print-report', arguments:{uuid:'{{ $project->uuid }}'}})" --}} x-on:click="window.print()">
                Cetak
                Laporan
            </button>
        </div>
            ...
            <div class="mt-5 overflow-x-auto" x-show="show=='attendance'">
                <table class="w-full print:visible print:top-0 print:left-0 print:absolute" id="table">
                    ...
                    <tr
                        ...
                        @endfor
                        <th class="py-3 font-normal text-right">Hari</th>
                        <th class="py-3 px-1 font-normal text-right">Uang Makan 1x</th>
                        <th class="py-3 px-1 font-normal text-right">Jumlah</th>
                    ...
                    @foreach ($users as $user)
                        ...
                        <tr
                            ...
                            @endif
                            <td class="py-3 print:py-0 font-normal text-right min-w-16 max-w-16 text-nowrap">
                                {{ $totalMultiply }}</td>
                            <td class="py-3 px-1 print:py-0 font-normal min-w-16 max-w-16 text-nowrap">
                                <div class="flex justify-between">
                                    <p>Rp</p>
                                    <p>
                                        &nbsp;{{ number_format($user->profile->lunch_price, 0, '.', '.') }}
                                    </p>
                                </div>
                            </td>
                            <td class="py-3 px-1 print:py-0 font-normal min-w-20 flex justify-between">
                                <p>Rp</p>
                                <p class="">
                    ...
                    <tr
                        ...
                        <td class="py-3 print:py-0 px-1 font-normal flex justify-between">
                            <p>Rp</p>
                            <p>
                    ...
                    @if (auth()->user()->role_id != 1 && auth()->user()->role_id != 3)
                        ...
                        <tr>
                            <td colspan="{{ ceil((count($listDates) + 5) / 2) }}"
                                class="dark:text-white text-black print:dark:text-black text-xs">Dibuat oleh:
                            </td>
