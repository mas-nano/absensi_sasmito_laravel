...
<div x-data="{ show: 'attendance' }">
    <div class="flex justify-between items-center">
        ...
        <button class="py-1 px-2 bg-black dark:bg-[#a4a5f7] text-xs text-white dark:text-black rounded-lg"
            wire:click="$dispatch('openModal', { component: 'report.print-report', arguments:{uuid:'{{ $project->uuid }}'}})">Cetak
            Laporan
        </button>
    </div>
                ...
                <tbody>
                    @forelse ($attendances as $item)
                        <tr class="text-black dark:text-white text-xs">
                            ...
                            <td class="py-3 font-normal">{{ \Carbon\Carbon::parse($item->created_at)->toTimeString() }}
                            </td>
